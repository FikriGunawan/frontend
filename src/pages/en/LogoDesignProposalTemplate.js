...
import imgLogodesignproposaltemplateheader from '../../assets/images/resources/logo-design-proposal-template-header.jpg';
import imgLogodesignproposaltemplateheadermobile from '../../assets/images/resources/logo-design-proposal-template-header-mobile.jpg';
import imgArrowDown from '../../assets/images/arrowDown.png';
import imgLogodesignproposaltemplateimage from '../../assets/images/resources/logo-design-proposal-template-image.png';
import imgLogodesignproposaltemplateornament from '../../assets/images/resources/logo-design-proposal-template-ornament.png';
import imgLogodesignproposaltemplateornamentmobile from '../../assets/images/resources/logo-design-proposal-template-ornament-mobile.png';
...
function sendEmail(e) {
  ...
  emailjs.sendForm(
    ...
    'user_MlLNxrp3PV3vyrlG5uG5C'
      ...
      window.location.href = 'http://ompfe.okular.co.id/static/media/OMP-Logo-Design-Proposal-Template.37bb3fd5.pdf';
  }, (error) => {
...
const LogoDesignProposalTemplate = () => {
  
  return (
    <>
      {/* Navbar */}
      <Navbar
        langID='/id/logo-design-proposal-template'
        langEN='/en/logo-design-proposal-template'
      />
      ...
      <div id='mainResourcesDetail' className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-lg-12 resourcesDetailHeader'>
            <div className='wrap'>
              <h1>
                <span>Logo Design<br />Proposal Template</span>
              </h1>
            </div>				
            <img className='img-fluid background d-none d-lg-block' src={imgLogodesignproposaltemplateheader} alt='Okular Mentorship Program' />
            <img className='img-fluid background d-block d-lg-none' src={imgLogodesignproposaltemplateheadermobile} alt='Okular Mentorship Program' />
          ...
          <div id='resourceDetailForm' className='col-lg-4 py-m-0 py-lg-10p px-m-0 px-lg-5p resourcesDetailForm'>
            <img className='img-fluid d-none d-lg-block' src={imgLogodesignproposaltemplateimage} alt='Okular Mentorship Program' />
            <img className='img-fluid ornament d-none d-lg-block' src={imgLogodesignproposaltemplateornament} alt='Okular Mentorship Program' />
          </div>
          <div className='col-lg-8 py-m-20p py-lg-10p px-m-10p px-lg-5p resourcesDetailForm'>
            <div className='wrap'>
              <h6>LOGO DESIGN PROPOSAL TEMPLATE</h6>
            ...
            <img className='img-fluid d-block d-lg-none' src={imgLogodesignproposaltemplateimage} alt='Okular Mentorship Program' />
            <form onSubmit={sendEmail}>
              <input type='hidden' name='your-resources' className='form-control' value='Logo Design Proposal Template'/>
          ...
          <div className='col-12 pb-m-20p px-m-0 resourcesDetailForm d-inline-block d-lg-none'>
            <img className='img-fluid ornament' src={imgLogodesignproposaltemplateornamentmobile} alt='Okular Mentorship Program' />
          </div>
...
export default LogoDesignProposalTemplate;