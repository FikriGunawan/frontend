...
import imgQuizImages04 from '../../assets/images/quiz/quizImages04.png';
import imgQuizImagesMobile04 from '../../assets/images/quiz/quizImagesMobile04.png';
import imgQuizLine from '../../assets/images/quiz/quizLine.png';
import imgQuizIcon02 from '../../assets/images/quiz/quizIcon02.png';
import imgQuizOrnamentMobile02 from '../../assets/images/quiz/quizOrnamentMobile02.png';
import imgQuizImages07 from '../../assets/images/quiz/quizImages07.png';
...
class QuizCategory02 extends React.Component{
  ...
  componentDidMount(){
    fetch(`http://ompcms.okular.co.id/quiz-category-2?_locale=en`).then((response) => {
      if(response.status >= 400){
        throw new Error("Bad Response From Server");
      }
      return response.json();
    }).then((quizcat) => {
      this.setState({QuizCategory02Page: quizcat});
  ...
  render(){
    const {
      ...
      Category_Item2_Link
    } = this.state.QuizCategory02Page;
    return (
      <>
        {/* Navbar */}
        <Navbar
          langID='/id/quiz-category-02'
          langEN='/en/quiz-category-02'
        />
