...
import imgClassHeader03 from '../../assets/images/class/classHeader03.png';
import imgClassHeaderMobile03 from '../../assets/images/class/classHeaderMobile03.png';
import imgArrowDownBlack from '../../assets/images/arrowDownBlack.png';
import imgClassBrief03 from '../../assets/images/class/classBrief03.png';
import imgClassBriefMobile03 from '../../assets/images/class/classBriefMobile03.png';
...
class CompleteDesignCourse extends React.Component{
  ...
  componentDidMount(){
    fetch(`http://ompcms.okular.co.id/complete-design-course?_locale=en`).then((response) => {
      if(response.status >= 400){
        throw new Error("Bad Response From Server");
      }
      return response.json();
    }).then((CDC) => {
      this.setState({CDCPage: CDC});
      this.setState({Header_Image: CDC.Header_Image.url});
      this.setState({Header_Image_Mobile: CDC.Header_Image_Mobile.url});
      this.setState({Brief_Image: CDC.Brief_Image.url});
      this.setState({Brief_Image_Mobile: CDC.Brief_Image_Mobile.url});
      this.setState({Register_Image: CDC.Register_Image.url});
      this.setState({Register_Image_Mobile: CDC.Register_Image_Mobile.url});
      this.setState({Category_Item1_Icon: CDC.Category_Item1_Icon.url});
      this.setState({Category_Item2_Icon: CDC.Category_Item2_Icon.url});
    })
  }
  ...
  render(){
    ...
    return (
      <>
        {/* Navbar */}
        <Navbar
          langID='/id/complete-design-course'
          langEN='/en/complete-design-course'
        />
                  ...
                  <div className='container-fluid boxc'>
                    <div className='row'>
                      <div className='col-lg-6 item'>
                        ...
                        <p>Introduction to Design Apps</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>How to handle clients well</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Stages to design</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                      ...
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Execution of design from concept to completion</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>How to determine the price</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>In-depth discussion of Identity Design</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>How to get clients</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>File preparation for production</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Ways to prospect clients</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Character as a designer</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>How to prepare a good portfolio</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <OwlCarousel className='carouselCaPInterested owl-theme d-block d-lg-none' data-aos='fade-up' data-aos-duration='1300' {...optionCarouselCaPInterested}>
                <div className='item'>
                  ...
                  <div className='desc boxc'>
                    <p className='boxc'><b>interested in working in the Graphic Design industry</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>want to develop a way of working in the world of Graphic Design</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>want to prepare before entering the work environment or adapting to the world of work environment</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>are preparing to start a career to open a creative agency or are interested in freelancing</b></p>
                  </div>
                </div>
              </OwlCarousel>
            ...
            <div className='col-lg-6 pt-m-0 pb-m-20p pt-lg-5p pb-lg-10p px-m-10p pr-lg-5p CaPRegister bgLightGrey'>
              <div>
                <form onSubmit={sendEmail}>
                  <input type='hidden' name='your-package' className='form-control' value='Complete Design Course'/>
...
export default CompleteDesignCourse;