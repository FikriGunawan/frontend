...
class FundamentalDesignCourse extends React.Component{
  ...
  componentDidMount(){
    fetch(`http://ompcms.okular.co.id/fundamental-design-course?_locale=en`).then((response) => {
            ...
            <div className='col-lg-12 pb-m-20p py-lg-10p px-m-0 px-lg-0 CaPInterested bgLightGrey text-center'>
              ...
              <OwlCarousel className='carouselCaPInterested owl-theme d-block d-lg-none' data-aos='fade-up' data-aos-duration='1300' {...optionCarouselCaPInterested}>
                ...
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>want to prepare before entering the world of work</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>have difficulty adapting in the world of work</b></p>
                  </div>
                </div>
              </OwlCarousel>
