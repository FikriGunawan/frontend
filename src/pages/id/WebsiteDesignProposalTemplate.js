...
import imgWebsitedesignproposaltemplateheader from '../../assets/images/resources/website-design-proposal-template-header.jpg';
import imgWebsitedesignproposaltemplateheadermobile from '../../assets/images/resources/website-design-proposal-template-header-mobile.jpg';
import imgArrowDown from '../../assets/images/arrowDown.png';
import imgWebsitedesignproposaltemplateimage from '../../assets/images/resources/website-design-proposal-template-image.png';
import imgWebsitedesignproposaltemplateornament from '../../assets/images/resources/website-design-proposal-template-ornament.png';
import imgWebsitedesignproposaltemplateornamentmobile from '../../assets/images/resources/website-design-proposal-template-ornament-mobile.png';
...
function sendEmail(e) {
  ...
  emailjs.sendForm(
    ...
    'user_MlLNxrp3PV3vyrlG5uG5C'
      ...
      window.location.href = 'http://ompfe.okular.co.id/static/media/OMP-Website-Design-Proposal-Template.571e59e6.pdf';
  }, (error) => {
...
const WebsiteDesignProposalTemplate = () => {
  
  return (
    <>
      {/* Navbar */}
      <Navbar
        langID='/id/website-design-proposal-template'
        langEN='/en/website-design-proposal-template'
      />
      ...
      <div id='mainResourcesDetail' className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-lg-12 resourcesDetailHeader'>
            <div className='wrap'>
              <h1>
                <span>Website Design<br />Proposal Template</span>
              </h1>
            </div>				
            <img className='img-fluid background d-none d-lg-block' src={imgWebsitedesignproposaltemplateheader} alt='Okular Mentorship Program' />
            <img className='img-fluid background d-block d-lg-none' src={imgWebsitedesignproposaltemplateheadermobile} alt='Okular Mentorship Program' />
          ...
          <div id='resourceDetailForm' className='col-lg-4 py-m-0 py-lg-10p px-m-0 px-lg-5p resourcesDetailForm'>
            <img className='img-fluid d-none d-lg-block' src={imgWebsitedesignproposaltemplateimage} alt='Okular Mentorship Program' />
            <img className='img-fluid ornament d-none d-lg-block' src={imgWebsitedesignproposaltemplateornament} alt='Okular Mentorship Program' />
          </div>
          <div className='col-lg-8 py-m-20p py-lg-10p px-m-10p px-lg-5p resourcesDetailForm'>
            <div className='wrap'>
              <h6>WEBSITE DESIGN PROPOSAL TEMPLATE</h6>
            ...
            <img className='img-fluid d-block d-lg-none' src={imgWebsitedesignproposaltemplateimage} alt='Okular Mentorship Program' />
            <form onSubmit={sendEmail}>
              <input type='hidden' name='your-resources' className='form-control' value='Website Design Proposal Template'/>
          ...
          <div className='col-12 pb-m-20p px-m-0 resourcesDetailForm d-inline-block d-lg-none'>
            <img className='img-fluid ornament' src={imgWebsitedesignproposaltemplateornamentmobile} alt='Okular Mentorship Program' />
          </div>
...
export default WebsiteDesignProposalTemplate;