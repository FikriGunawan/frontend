...
import imgClassHeader01 from '../../assets/images/class/classHeader01.png';
import imgClassHeaderMobile01 from '../../assets/images/class/classHeaderMobile01.png';
import imgArrowDownBlack from '../../assets/images/arrowDownBlack.png';
import imgClassBrief01 from '../../assets/images/class/classBrief01.png';
import imgClassBriefMobile01 from '../../assets/images/class/classBriefMobile01.png';
...
class FundamentalDesignCourse extends React.Component{
  ...
  componentDidMount(){
    fetch(`http://ompcms.okular.co.id/fundamental-design-course?_locale=id`).then((response) => {
      if(response.status >= 400){
        throw new Error("Bad Response From Server");
      }
      return response.json();
    }).then((FDC) => {
      this.setState({FDCPage: FDC});
      this.setState({Header_Image: FDC.Header_Image.url});
      this.setState({Header_Image_Mobile: FDC.Header_Image_Mobile.url});
      this.setState({Brief_Image: FDC.Brief_Image.url});
      this.setState({Brief_Image_Mobile: FDC.Brief_Image_Mobile.url});
      this.setState({Register_Image: FDC.Register_Image.url});
      this.setState({Register_Image_Mobile: FDC.Register_Image_Mobile.url});
      this.setState({Category_Item1_Icon: FDC.Category_Item1_Icon.url});
      this.setState({Category_Item2_Icon: FDC.Category_Item2_Icon.url});
    })
  }
  ...
  render(){
    ...
    return (
      <>
        {/* Navbar */}
        <Navbar
          langID='/id/fundamental-design-course'
          langEN='/en/fundamental-design-course'
        />
            ...
            <div className='col-lg-12 pb-m-20p py-lg-10p px-m-0 px-lg-0 CaPInterested bgLightGrey text-center'>
              ...
              <OwlCarousel className='carouselCaPInterested owl-theme d-block d-lg-none' data-aos='fade-up' data-aos-duration='1300' {...optionCarouselCaPInterested}>
                ...
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>ingin mempersiapkan diri sebelum memasuki dunia kerja</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>memiliki kesulitan beradaptasi di dalam dunia kerja</b></p>
                  </div>
                </div>
              </OwlCarousel>
            ...
            <div className='col-lg-6 pt-m-0 pb-m-20p pt-lg-5p pb-lg-10p px-m-10p pr-lg-5p CaPRegister bgLightGrey'>
              <div>
                <form onSubmit={sendEmail}>
                  <input type='hidden' name='your-package' className='form-control' value='Fundamental Design Course'/>
...
export default FundamentalDesignCourse;