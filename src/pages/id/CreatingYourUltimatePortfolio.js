...
import imgPortfolioheader from '../../assets/images/resources/portfolio-header.jpg';
import imgPortfolioheadermobile from '../../assets/images/resources/portfolio-header-mobile.jpg';
import imgArrowDown from '../../assets/images/arrowDown.png';
import imgPortfolioimage from '../../assets/images/resources/portfolio-image.png';
import imgPortfolioornament from '../../assets/images/resources/portfolio-ornament.png';
import imgPortfolioornamentmobile from '../../assets/images/resources/portfolio-ornament-mobile.png';
...
function sendEmail(e) {
  ...
  emailjs.sendForm(
    ...
    'user_MlLNxrp3PV3vyrlG5uG5C'
      ...
      window.location.href = 'http://ompcfe.okular.co.id/static/media/OMP-Creating-Your-Ultimate-Portfolio.46365c3b.pdf';
  }, (error) => {
...
const CreatingYourUltimatePortfolio = () => {
  
  return (
    <>
      {/* Navbar */}
      <Navbar
        langID='/id/creating-your-ultimate-portfolio'
        langEN='/en/creating-your-ultimate-portfolio'
      />
      ...
      <div id='mainResourcesDetail' className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-lg-12 resourcesDetailHeader'>
            ...
            <img className='img-fluid background d-none d-lg-block' src={imgPortfolioheader} alt='Okular Mentorship Program' />
            <img className='img-fluid background d-block d-lg-none' src={imgPortfolioheadermobile} alt='Okular Mentorship Program' />
          ...
          <div id='resourceDetailForm' className='col-lg-4 py-m-0 py-lg-10p px-m-0 px-lg-5p resourcesDetailForm'>
            <img className='img-fluid d-none d-lg-block' src={imgPortfolioimage} alt='Okular Mentorship Program' />
            <img className='img-fluid ornament d-none d-lg-block' src={imgPortfolioornament} alt='Okular Mentorship Program' />
          </div>
          <div className='col-lg-8 py-m-20p py-lg-10p px-m-10p px-lg-5p resourcesDetailForm'>
            <div className='wrap'>
              <h6>CREATING YOUR ULTIMATE PORTFOLIO</h6>
            ...
            <img className='img-fluid d-block d-lg-none' src={imgPortfolioimage} alt='Okular Mentorship Program' />
            <form onSubmit={sendEmail}>
              <input type='hidden' name='your-resources' className='form-control' value='Creating Your Ultimate Portfolio'/>
          ...
          <div className='col-12 pb-m-20p px-m-0 resourcesDetailForm d-inline-block d-lg-none'>
            <img className='img-fluid ornament' src={imgPortfolioornamentmobile} alt='Okular Mentorship Program' />
          </div>
...
export default CreatingYourUltimatePortfolio;