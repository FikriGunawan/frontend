...
import imgFinalprojectheader from '../../assets/images/resources/final-project-header.jpg';
import imgFinalprojectheadermobile from '../../assets/images/resources/final-project-header-mobile.jpg';
import imgArrowDown from '../../assets/images/arrowDown.png';
import imgFinalprojectimage from '../../assets/images/resources/final-project-image.png';
import imgFinalprojectornament from '../../assets/images/resources/final-project-ornament.png';
import imgFinalprojectornamentmobile from '../../assets/images/resources/final-project-ornament-mobile.png';
...
function sendEmail(e) {
  ...
  emailjs.sendForm(
    ...
    'user_MlLNxrp3PV3vyrlG5uG5C'
      ...
      window.location.href = 'http://ompcfe.okular.co.id/static/media/OMP-Determining-Your-Final-Project.373c147a.pdf';
  }, (error) => {
...
const DeterminingtheFinalProject = () => {
  
  return (
    <>
      {/* Navbar */}
      <Navbar
        langID='/id/determining-the-final-project'
        langEN='/en/determining-the-final-project'
      />
      ...
      <div id='mainResourcesDetail' className='container-fluid'>
        <div className='row'>
          ...
          <div className='col-lg-12 resourcesDetailHeader'>
            ...
            <img className='img-fluid background d-none d-lg-block' src={imgFinalprojectheader} alt='Okular Mentorship Program' />
            <img className='img-fluid background d-block d-lg-none' src={imgFinalprojectheadermobile} alt='Okular Mentorship Program' />
          ...
          <div id='resourceDetailForm' className='col-lg-4 py-m-0 py-lg-10p px-m-0 px-lg-5p resourcesDetailForm'>
            <img className='img-fluid d-none d-lg-block' src={imgFinalprojectimage} alt='Okular Mentorship Program' />
            <img className='img-fluid ornament d-none d-lg-block' src={imgFinalprojectornament} alt='Okular Mentorship Program' />
          </div>
          <div className='col-lg-8 py-m-20p py-lg-10p px-m-10p px-lg-5p resourcesDetailForm'>
            <div className='wrap'>
              <h6>DETERMINING THE FINAL PROJECT</h6>
            ...
            <img className='img-fluid d-block d-lg-none' src={imgFinalprojectimage} alt='Okular Mentorship Program' />
            <form onSubmit={sendEmail}>
              <input type='hidden' name='your-resources' className='form-control' value='Determining the Final Project'/>
          ...
          <div className='col-12 pb-m-20p px-m-0 resourcesDetailForm d-inline-block d-lg-none'>
            <img className='img-fluid ornament' src={imgFinalprojectornamentmobile} alt='Okular Mentorship Program' />
          </div>
...
export default DeterminingtheFinalProject;