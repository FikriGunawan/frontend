                ...
                <div className='col-lg-12 pb-lg-10p px-lg-5p wrap'>
                  <form action='process.php' method='post' enctype='multipart/form-data'>
                    <div className='form-group'>
                      <p><b>1. Berikut merupakan tools yang termasuk dalam kategori Transformation tools, <span>KECUALI</span>:</b></p>
                    ...
                    <div className='form-group'>
                      <p><b>2. Kalian dapat mengubah lebar dan panjang artboard setelah kalian membuatnya.</b></p>
                      <div className='switch-field'>
                        <input type='radio' id='p2q2r1' name='q7' value='Benar' />
                        <label for='p2q2r1'>Benar</label>
                        <input type='radio' id='p2q2r2' name='q7' value='Salah' />
                        <label for='p2q2r2'>Salah</label>
                        <input type='radio' id='p2q2r3' name='q7' value='Hanya pada saat mengecilkan ukuran artboard-nya' />
                        <label for='p2q2r3'>Hanya pada saat mengecilkan ukuran artboard-nya</label>
                      </div>
                    </div>
                    <div className='form-group'>
                      <p><b>3. Dimana kalian dapat menemukan Drop Shadow Effect?</b></p>
                      <div className='switch-field'>
                    ...
                    <Link className='btnBlack prev d-none d-lg-inline-block' to='/id/quiz-question-01'>Bagian Sebelumnya</Link>
                    <Link className='btnBlack next d-none d-lg-block' to='/id/quiz-question-03'>Lanjut</Link>
                    <div className='cta d-block d-lg-none'>
                      <h6>PART 2 DARI 5</h6>
                      <Link className='prev boxc' to='/id/quiz-question-01'><img className='img-fluid' src={imgArrowPrev} /></Link>
                      <Link className='next boxc' to='/id/quiz-question-03'><img className='img-fluid' src={imgArrowNext} /></Link>
                    </div>
                  </form>
                </div>
              </div>
