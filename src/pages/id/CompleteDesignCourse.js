...
class CompleteDesignCourse extends React.Component{
  ...
  componentDidMount(){
    fetch(`http://ompcms.okular.co.id/complete-design-course?_locale=id`).then((response) => {
                  ...
                  <div className='container-fluid boxc'>
                    <div className='row'>
                      <div className='col-lg-6 item'>
                        ...
                        <p>Pengenalan untuk Aplikasi Desain</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Cara Menangani klien dengan baik</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Tahap untuk mendesain</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Filosofi desain</p>
                      ...
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Penyusunan Moodboard</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Persiapan resume</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Penyusunan Proposal</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Latihan presentasi</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Eksekusi desain dari konsep sampai selesai</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                      ...
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Pembahasan mendalam tentang Desain Identitas</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                      ...
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
                        <p>Persiapan file untuk produksi</p>
                      </div>
                      <div className='col-lg-6 item'>
                        <img className='img-fluid icon' src={imgPoint} alt='Okular Mentorship Program' />
              ...
              <OwlCarousel className='carouselCaPInterested owl-theme d-block d-lg-none' data-aos='fade-up' data-aos-duration='1300' {...optionCarouselCaPInterested}>
                <div className='item'>
                  ...
                  <div className='desc boxc'>
                    <p className='boxc'><b>tertarik untuk bekerja di dalam industry Desain Grafis</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>ingin mengembangkan cara bekerja dalam dunia Desain Grafis</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>ingin mempersiapkan diri sebelum memasuki lingkungan kerja atau beradaptasi dengan dunia lingkungan kerja</b></p>
                  </div>
                </div>
                <div className='item'>
                  <img className='img-fluid icon' src={imgOrnament03} alt='Okular Mentorship Program' />
                  <div className='desc boxc'>
                    <p className='boxc'><b>sedang mempersiapkan untuk memulai karir untuk membuka agen kreatif atau tertarik dengan freelancing</b></p>
                  </div>
                </div>
              </OwlCarousel>
